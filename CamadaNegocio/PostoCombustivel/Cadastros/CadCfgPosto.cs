...
{
    public class TCN_CfgPosto
    {
        public static TList_CfgPosto Buscar(string Cd_empresa,
                                            BancoDados.TObjetoBanco banco)
        {
            ...
            return new TCD_CfgPosto(banco).Select(filtro, 0, string.Empty);
        }

        public static string Gravar(TRegistro_CfgPosto val, BancoDados.TObjetoBanco banco)
        {
            bool st_transacao = false;
            TCD_CfgPosto qtb_cfg = new TCD_CfgPosto();
            try
            {
                if (banco == null)
        ...
        public static string Excluir(TRegistro_CfgPosto val, BancoDados.TObjetoBanco banco)
        {
            bool st_transacao = false;
            TCD_CfgPosto qtb_cfg = new TCD_CfgPosto();
            try
