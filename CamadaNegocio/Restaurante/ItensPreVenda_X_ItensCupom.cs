...
{
    public class TCN_ItensPreVenda_X_ItensCupom
    {
        ...
        public static TList_ItensPreVenda_X_ItensCupom Buscar(string Cd_empresa,
                                                              string id_prevenda,
                                                              string id_lancto,
                                                              string id_cupom,
                                                              string id_item,
                                                              BancoDados.TObjetoBanco banco)
        {
            ...
            return new TCD_ItensPreVenda_X_ItensCupom(banco).Select(filtro, 0, string.Empty);
        }

        public static string Gravar(TRegistro_ItensPreVenda_X_ItensCupom val, BancoDados.TObjetoBanco banco)
        {
            bool st_transacao = false;
            TCD_ItensPreVenda_X_ItensCupom qtb_orc = new TCD_ItensPreVenda_X_ItensCupom();
            try
            {
                if (banco == null)
        ...
        public static string Excluir(TRegistro_ItensPreVenda_X_ItensCupom val, BancoDados.TObjetoBanco banco)
        {
            bool st_transacao = false;
            TCD_ItensPreVenda_X_ItensCupom qtb_orc = new TCD_ItensPreVenda_X_ItensCupom();
            try
        ...
        public static void CancelarCF(TRegistro_NFCe val, TRegistro_VendaRapida venda, BancoDados.TObjetoBanco banco)
        {
            ...
            try
            {
                ...
                {
                    TList_ItensPreVenda_X_ItensCupom itens = new TList_ItensPreVenda_X_ItensCupom();
