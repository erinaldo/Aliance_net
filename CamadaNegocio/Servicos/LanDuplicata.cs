...
{
    public class TCN_LanServico_X_Duplicata
    {
        ...
        public static string Gravar(TRegistro_LanServico_X_Duplicata val, BancoDados.TObjetoBanco banco)
        {
            bool st_transacao = false;
            TCD_LanServico_X_Duplicata qtb_os = new TCD_LanServico_X_Duplicata();
            try
            {
                if (banco == null)
        ...
        public static string Excluir(TRegistro_LanServico_X_Duplicata val, BancoDados.TObjetoBanco banco)
        {
            bool st_transacao = false;
            TCD_LanServico_X_Duplicata qtb_os = new TCD_LanServico_X_Duplicata();
            try
