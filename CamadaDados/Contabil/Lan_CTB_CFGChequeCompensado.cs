...
{
    public class TList_CTB_CFGCheque_Compensado : List<TRegistro_CTB_CFGCheque_Compensado>, IComparer<TRegistro_CTB_CFGCheque_Compensado>
    {
        #region IComparer<TRegistro_CTB_CFGCheque_Compensado> Members
        ...
        public TList_CTB_CFGCheque_Compensado()
        { }

        public TList_CTB_CFGCheque_Compensado(System.ComponentModel.PropertyDescriptor Prop,
        ...
        private object GetPropertyValue(TRegistro_CTB_CFGCheque_Compensado value,
                                        string Propriedade)
        {
        ...
        public int Compare(TRegistro_CTB_CFGCheque_Compensado x, TRegistro_CTB_CFGCheque_Compensado y)
        {
    ...
    public class TRegistro_CTB_CFGCheque_Compensado
    {
        ...
        public TRegistro_CTB_CFGCheque_Compensado()
        {
            ...
            this.Cd_contager_entrada = string.Empty;
            this.Cd_contager_saida = string.Empty;
            this.Ds_conta_ctb_cred = string.Empty;
            this.Ds_conta_ctb_deb = string.Empty;
            this.Ds_contager_entrada = string.Empty;
            this.Ds_contager_saida = string.Empty;
            this.id_cfgctb = null;
    ...
    public class TCD_CTB_CFGCheque_Compensado : TDataQuery
    {
        public TCD_CTB_CFGCheque_Compensado() { }

        public TCD_CTB_CFGCheque_Compensado(BancoDados.TObjetoBanco banco) { this.Banco_Dados = banco; }
        ...
        private string SqlCodeBusca(TpBusca[] vBusca, Int32 vTop, string vNM_Campo)
        {
            ...
            sql.AppendLine("FROM TB_CTB_ChequeCompensado a ");
        ...
        public TList_CTB_CFGCheque_Compensado Select(TpBusca[] vBusca, Int32 vTop, string vNM_Campo)
        {
            TList_CTB_CFGCheque_Compensado lista = new TList_CTB_CFGCheque_Compensado();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    TRegistro_CTB_CFGCheque_Compensado reg = new TRegistro_CTB_CFGCheque_Compensado();
        ...
        public string Grava(TRegistro_CTB_CFGCheque_Compensado vRegistro)
        {
            ...
            return this.executarProc("IA_CTB_CHEQUECOMPENSADO", hs);
        }

        public string Deleta(TRegistro_CTB_CFGCheque_Compensado vRegistro)
        {
            Hashtable hs = new Hashtable(1);

            hs.Add("@P_ID_CFGCTB", vRegistro.Id_cfgctb);

            return this.executarProc("EXCLUI_CTB_CHEQUECOMPENSADO", hs);
        }
    }
}
