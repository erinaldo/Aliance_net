...
namespace CamadaDados.Empreendimento
{
    ...
    public class TCD_Orcamento : TDataQuery
    {
        ...
        private string SqlCodeBusca(Utils.TpBusca[] vBusca, Int32 vTop, string vNM_Campo)
        {
            ...
            if (string.IsNullOrEmpty(vNM_Campo))
            {
                ...
                sql.AppendLine("a.CD_Endereco, d.ds_endereco, a.CD_Vendedor, v.nm_clifor as nm_vendedor, ");
                ...
                sql.AppendLine("f.uf as uf_emp, a.dt_orcamento, a.dt_previni, a.dt_prevfin, a.ds_motivo, a.st_registro ");
            }
            else
                sql.AppendLine(" Select " + strTop + " " + vNM_Campo + " ");

            sql.AppendLine("from TB_EMP_Orcamento a ");
            ...
            sql.AppendLine("left outer join TB_FIN_Clifor v ");
            sql.AppendLine("on a.CD_Vendedor = v.CD_Clifor ");
    ...
    public class TCD_Despesas : TDataQuery
    {
        ...
        private string SqlCodeBusca(Utils.TpBusca[] vBusca, Int32 vTop, string vNM_Campo)
        {
            ...
            {
                sql.AppendLine("select " + strTop + " a.cd_empresa, a.id_orcamento, ");
                sql.AppendLine("a.nr_versao, a.id_despesa, SPACE((a.NIVEL-1)*5) + a.ds_despesa as ds_despesa, ");
