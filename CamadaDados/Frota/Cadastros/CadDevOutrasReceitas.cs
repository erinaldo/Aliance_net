    ...
    public class TCD_DevOutrasReceitas : TDataQuery
    {
        ...
        private string SqlCodeBusca(Utils.TpBusca[] vBusca, Int32 vTop, string vNM_Campo)
        {
            ...
            if (string.IsNullOrEmpty(vNM_Campo))
                sql.AppendLine("select " + strTop + " a.ID_Receita, a.CD_ContaGer, a.CD_LanctoCaixa ");
            else
                sql.AppendLine("Select " + strTop + " " + vNM_Campo + " ");

            sql.AppendLine("from TB_FRT_DevAdtoOutrasRec a ");
        ...
        public string Excluir(CamadaDados.Frota.Cadastros.TRegistro_DevOutrasReceitas val)
        {
            ...
            return this.executarProc("EXCLUI_FRT_DEVADTOOUTRASREC", hs);
        }
    }
}
