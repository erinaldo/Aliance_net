...
namespace Producao
{
    public partial class TFNovoLote : Form
    {
        ...
        private CamadaDados.Producao.Producao.TRegistro_Rastreabilidade rlote;
        public CamadaDados.Producao.Producao.TRegistro_Rastreabilidade rLote
        {
            get
            {
                if (bsLote.Current != null)
                    return bsLote.Current as CamadaDados.Producao.Producao.TRegistro_Rastreabilidade;
                else
                    return null;
            }
            set { rlote = value; }
        ...
        private void afterGrava()
        {
            ...
            {
                MessageBox.Show("Obrigatório informar Nº Lote!", "Mensagem", MessageBoxButtons.OK, MessageBoxIcon.Information);
                nr_lote.Focus();
                return;
            }
        ...
        private void TFNovoLote_Load(object sender, EventArgs e)
        {
            ...
            if (rlote != null)
            {
                bsLote.DataSource = new CamadaDados.Producao.Producao.TList_Rastreabilidade { rlote };
