...
namespace Contabil.Cadastros
{
    public partial class TFParamDRE : Form
    {
        ...
        {get;set;}
        private CamadaDados.Contabil.Cadastro.TRegistro_CTB_paramDRE rparam;
        public CamadaDados.Contabil.Cadastro.TRegistro_CTB_paramDRE rParam
        {
            get
            {
                if (bsParamDRE.Current != null)
                    return bsParamDRE.Current as CamadaDados.Contabil.Cadastro.TRegistro_CTB_paramDRE;
                else return null;
            }
            set { rparam = value; }
        }
        ...
        private void TFParamDRE_Load(object sender, EventArgs e)
        {
            ...
            if (rparam == null)
                bsParamDRE.AddNew();
            else bsParamDRE.DataSource = new CamadaDados.Contabil.Cadastro.TList_CTB_paramDRE() { rparam };
        }
        ...
        private void bb_parampai_Click(object sender, EventArgs e)
        {
            ...
            FormBusca.UtilPesquisa.BTN_BUSCA(vColunas, new Componentes.EditDefault[] { id_parampai, ds_parampai },
                new CamadaDados.Contabil.Cadastro.TCD_CTD_paramDRE(), vParam);
        }
        ...
        private void id_parampai_Leave(object sender, EventArgs e)
        {
            ...
            FormBusca.UtilPesquisa.EDIT_LEAVE(vParam, new Componentes.EditDefault[] { id_parampai, ds_parampai },
                new CamadaDados.Contabil.Cadastro.TCD_CTD_paramDRE());
        }
